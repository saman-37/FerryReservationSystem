...
// Provides public interface to create new sailings, delete
// existing ones, query specific sailing details, and print
// a complete sailing report.
// Interfaces with the Sailing entity and the Reservation
// module.
// July 20, 2025 Version 3 - Team 18
//*********************************************************
...
public:
    ...
    // out: true if sailing is successfully created, false
    // otherwise
    //*********************************************************
    static bool createSailing(const string &sailingId, 
