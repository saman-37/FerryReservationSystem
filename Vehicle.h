...
// Constants for vehicle dimensions and field lengths
static const float REGULAR_VEHICLE_HEIGHT = 2.0; // Maximum height for regular vehicles
static const float REGULAR_VEHICLE_LENGTH = 7.0; // Maximum length for regular vehicles
static const int LICENSE_PLATE_LENGTH = 10; // Maximum length for vehicle license plates
static const int PHONE_LENGTH = 14; // Maximum length for phone numbers
...
public:
    ...
    char license[LICENSE_PLATE_LENGTH + 1]; // Array to store vehicle license, +1 for null terminator
    char phone[PHONE_LENGTH + 1];           // Array to store phone number, +1 for null terminator
    ...
    //************************************************************
    Vehicle(const string &license, const string &phone, float height, float length);
    ...
    //************************************************************
    static bool writeVehicle(const string &license, const string &phone, float height, float length);
