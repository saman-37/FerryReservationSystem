...
// reservation.h
//*********************************************************
// Purpose: Represents a binary-storable reservation record
// with check-in status and provides all file-level
// operations for managing ferry reservations in a fixed-
// length format.
...
public:
    ...
    // Fixed sailing ID length and license length
    //*********************************************************
    ...
    // true if the vehicle has boarded
    bool onBoard;              
    ...
    // in: sailingId
    //*********************************************************
    static int getTotalReservationsOnSailing(
    ...
    // in: sailingId
    //*********************************************************
    static bool removeReservationsOnSailing(
                                    const string &sailingId);               
